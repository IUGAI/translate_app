          ...
          OpenAIChatCompletionChoiceMessageModel(
            content: [
              OpenAIChatCompletionChoiceMessageContentItemModel.text(
                ...
                "ЗАДАЧА:\n"
                "Ты получаешь текст на Языке A или Языке B. Определи язык оригинала и ПЕРЕВЕДИ его на ВТОРОЙ выбранный язык.\n"
                "Язык A: $lang1, Язык B: $lang2.\n\n"
                "ПРИКЛАДНОЙ ПРИМЕР:\n"
                "- Если ввод на Языке A -> переведи на Язык B. (toLanguage = B)\n"
                "- Если ввод на Языке B -> переведи на Язык A. (toLanguage = A)\n\n"
                "ФИЛОСОФИЯ ПЕРЕВОДА:\n"
                ...
                "- toLanguage — это язык, НА КОТОРЫЙ ты перевел (A или B).",
              ),
            ],
